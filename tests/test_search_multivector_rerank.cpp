...
#pragma omp parallel for schedule(dynamic, 1)
    ...
    evaluation_out << "Total Graph Search Time: " << total_graph_search_time << " seconds" << std::endl;
    evaluation_out << "Total Rerank Time: " << total_rerank_time << " seconds" << std::endl;
    evaluation_out << "Rerank time is " << total_rerank_time / (total_rerank_time + total_graph_search_time) * 100 << "%" << std::endl;
    if (evaluation_out.is_open()) {
