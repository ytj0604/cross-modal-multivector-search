...
using VectorGroundTruthType = std::shared_ptr<std::vector<std::vector<VectorID>>>;
...
class Loader {
 public:
  ...
  // Loads a vector-level ground truth file (generated by the RoarGraph using DiskANN's code)
  static VectorGroundTruthType LoadVectorGroundTruth(const std::string& file_path);
};
